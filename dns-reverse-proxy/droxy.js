(function(){
    ...
    function load_user_proxy_list(fname) {
        var data, url_list;
    ...
    function drop_root(options) {
        var _dns, chroot, rdir, ruser, k, resolv_path, _;
        "change root and drop root priviledge";
        _dns = require("dns");
        _dns.lookup("baidu.com", function(err, addr, fam) {
        });
        try {
    ...
    function run_servers(argv) {
        var dns_options, sogou_proxy_options, proxy_list, target_ip, dns_map, drouter, dproxy, sproxy, ipbox;
    ...
    function parse_args() {
        ...
        cmd_args = {
            ...
            "proxy-list": {
                "description": "Load user supplied proxy servers either " + "from a comma seperated list or " + "from a JSON file as a list of strings.",
                "default": null
            },
            "extra-url-list": {
