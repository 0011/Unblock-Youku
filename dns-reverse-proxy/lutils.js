(function(){
    ...
    function SogouManager(dns_resolver){
        var self = this;
    ...
    function createSogouManager(dns_resolver) {
        var s;
        s = new SogouManager(dns_resolver);
        return s;
    }
